            ...
            connection.execute(
                ...
                function (err, result) {
                    ...
                    req.forEach(function(item){
                        query.push("INTO items_temp (ITEM_AX_ID, ITEMNAME, ITEM_TYPES_ID, ITEMTHIN, ITEMHEIGHT, ITEMWIDTH, ITEMPRICE) VALUES");
                        query.push("(");
                        for(var i = 0; i < item.length; i ++){
                            if(i === 0 || i === 1){
